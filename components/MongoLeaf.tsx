/**
 * MongoDB leaf logomark, inlined from the official brand asset so it can inherit
 * `currentColor` and ship without an extra network request.
 * Source: MongoDB Brand Book — MongoDB_Logomark_White.svg
 */
export default function MongoLeaf({ size = 24, title }: { size?: number; title?: string }) {
  return (
    <svg
      width={size * (120 / 258)}
      height={size}
