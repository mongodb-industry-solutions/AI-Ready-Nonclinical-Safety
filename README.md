...
- A literature-evidence workspace that grounds SEND findings to attributed PubMed records, separates supporting context from alternative explanations, exposes the hybrid retrieval path, and opens verified open-access PDFs inside a wide evidence inspector while retaining PubMed as the source link.
